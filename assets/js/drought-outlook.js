...
function dateValue(data) {
    ...
    var imageUrl1 = "https://docs.google.com/uc?id=17vNUSA8xFZOQjc5KDdsDzC02pna7fvu4",
    ...
    var Image1 = L.imageOverlay(imageUrl1, imageBounds1, {
        opacity: 1,
        attribution: "Drought outlook till: " + addDays(date, 7)
    }).addTo(map);
    var imageUrl2 = "https://docs.google.com/uc?id=1jTlO8vfdtPaW1xxGwTxtwYXYfgvTm1CV",
    ...
    var Image2 = L.imageOverlay(imageUrl2, imageBounds2, {
        opacity: 1,
        attribution: "Drought outlook till: " + addDays(date, 15)
    })


    // layer control
    var baseLayers = {
        "7 Day Outlook": Image1,
        "15 Day Outlook": Image2,
    };
